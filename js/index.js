...
// Tópico anteriormente selecionado (se o usuário o tiver selecionado)
...
const updateLogo = (theme) => {
  if (theme === "dark") {
    logoDark.src = "./assets/imagens/logoLight.png";
  } else {
    logoDark.src = "./assets/imagens/logoDark.png";
  }
};
...
if (selectedTheme) {
  ...
  // Trocar a logo com base no tema atual
